        <ul>
            ...
            <!--    <li><?php echo $this->Html->link($this->Html->image("tr/Tags.png") . " " .  __('Tags'), array('controller' => 'tags', 'action' => 'index', 'plugin' => ''), array('escape' => false)); ?> </li>  -->
                ...
                <li><?php echo $this->Html->link($this->Html->image("tr/Invoice2.png") . " " .  __('Invoices'), array('controller' => 'invoices', 'action' => 'index', 'plugin' => ''), array('escape' => false)); ?> </li>
                <li><?php echo $this->Html->link($this->Html->image("tr/clipboard.png") . " " .  __('Picklists'), array('controller' => 'picklists', 'action' => 'index', 'plugin' => ''), array('escape' => false)); ?> </li>
