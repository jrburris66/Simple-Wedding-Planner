<div class="guestRoles view">
<h2><?php  echo __('Guest Role'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($guestRole['GuestRole']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($guestRole['GuestRole']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($guestRole['GuestRole']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Updated'); ?></dt>
		<dd>
			<?php echo h($guestRole['GuestRole']['updated']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Guest Role'), array('action' => 'edit', $guestRole['GuestRole']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Guest Role'), array('action' => 'delete', $guestRole['GuestRole']['id']), null, __('Are you sure you want to delete # %s?', $guestRole['GuestRole']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($guestRole['Guest'] as $guest): ?>
		<tr>
